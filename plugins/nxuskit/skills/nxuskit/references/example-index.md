<!-- generated: 2026-05-19; manifest: nxusKit-examples/conformance/examples_manifest.json; covered: 19/19; guidance-only: 0/19 -->

# nxusKit Example Index

Curated fallback index of the core nxusKit examples, generated from the examples manifest. Use this when selecting a starting point for an integration if the local MCP is unavailable. The MCP snapshot carries the full current examples portfolio (34 entries).
...
| vision | llm | CE | rust,go,python,cli/bash | llm,vision | Vision and multimodal capabilities with images | examples/patterns/vision/rust | n/a | - |
...
| solver-what-if | reasoning | Pro | rust,go,python,cli/bash | solver | What-if scenario analysis with solver scoping | examples/patterns/solver-what-if/rust | n/a | - |
...
- Total examples in MCP snapshot source: 34
